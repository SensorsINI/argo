...
Usage:
    sudo python3 nodes/argo_gui.py
    sudo ./nodes/argo_gui.sh
    python3 nodes/argo_gui.py --help
...
def require_sudo():
    ...
    if not check_sudo_privileges():
        ...
        print(f"{Colors.YELLOW}Please run with: sudo python3 nodes/argo_gui.py{Colors.RESET}")
        print(f"{Colors.DIM}Or use: sudo ./nodes/argo_gui.sh{Colors.RESET}")
        sys.exit(1)
...
============================================================"""
    ...
    def show_help(self):
        ...
        print(f"  Run with: {Colors.BOLD}sudo python3 nodes/argo_gui.py{Colors.RESET}")
        print(f"  Or use: {Colors.BOLD}sudo ./nodes/argo_gui.sh{Colors.RESET}")
        print()
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  sudo python3 nodes/argo_gui.py     # Start GUI (requires sudo)
  sudo ./nodes/argo_gui.sh           # Start GUI using launcher script
  python3 nodes/argo_gui.py --help   # Show help
