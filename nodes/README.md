...
**⚠️ IMPORTANT**: The BNO085 uses a **unique two-process architecture** (C++ driver + Python bridge) that requires systemd service management, unlike other sensor nodes. See **[README-imu-bno085.md](../docs/README-imu-bno085.md)** for complete documentation.
...
**Quick Start** (see [README-imu-bno085.md](../docs/README-imu-bno085.md) for details):
```bash
...
**Documentation**: See **[README-imu-bno085.md](../docs/README-imu-bno085.md)** for:
