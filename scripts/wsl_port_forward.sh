...
echo ""
echo "Or use one of these options:"
echo "  Option A - From Cursor: Ctrl+Shift+P -> Tasks: Run Task -> Forward WSL Port 8765"
echo "  Option B - From Windows Explorer: Right-click scripts\\wsl_port_forward.bat -> Run as Administrator"
echo "  Option C - From PowerShell (as Admin): powershell -ExecutionPolicy Bypass -File scripts\\wsl_port_forward.ps1"
echo ""
